...
export function NovaAtividadeModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[560px] p-0 overflow-hidden rounded-2xl border-0 shadow-2xl [&>button:last-child]:hidden">
        {/* Header colorido */}
        <div className="bg-[#2b5784] px-6 pt-5 pb-5 relative overflow-hidden">
          ...
          {/* Botão de fechar próprio (X padrão do shadcn fica atrás do fundo azul) */}
          <DialogClose
            disabled={loading}
