...
export default function ProgressBar({ done, total }: ProgressBarProps) {
  ...
  return (
    <div className="bg-white border-b border-[#f0f4f9] px-4 sm:px-5 py-3 flex items-center gap-3 sm:gap-4">
      ...
      <span className="text-xs text-[#9aadca] shrink-0 font-medium whitespace-nowrap">
